	...
	<form method="post" action="" id="listform" class="form-x">
		<div class="panel admin-panel">
			<div class="panel-head">
				<strong class="icon-reorder"> 采集器详情</strong> <a href=""
			...
			<div class="padding">
				<table class="table text-center table-bordered">
					...
					<tr>
						<td class="text-right">采集器ID</td>
						<td class="text-left"><?php echo $cmr["CMR_ID"]; ?></td>
					...
					<tr>
						...
						<td class="text-left"><?php echo $cmr["CMR_HW"]; ?></td>
						<td class="text-right">软件版本号</td>
						<td class="text-left"><?php echo $cmr["CMR_SW"]; ?></td>

					</tr>
					<tr>
						<td class="text-right">网络类型</td>
						<td class="text-left"><?php 
                        switch ($cmr['NETWORK_TYPE']){
					...
					<tr>
						...
						<td class="text-left"><?php echo $cmr["PHONE"]; ?></td>
						<td class="text-right">SIM卡IMSI</td>
						<td class="text-left"><?php echo $cmr["SIM_IMSI"];?></td>
					</tr>
					<tr>
						<td class="text-right">小区编号</td>
						<td class="text-left"><?php echo $cmr["VILLAGE_NO"]; ?></td>
						<td class="text-right">楼栋编号</td>
						<td class="text-left"><?php echo $cmr["BUILDING_NO"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">录入时间</td>
						<td class="text-left"><?php echo $cmr['TIME_ENTRY']?></td>
						<td class="text-right">安装时间</td>
						<td class="text-left"><?php echo $cmr['TIME_INSTALL']?></td>
					</tr>
					<tr>
						<td class="text-right">抄表周期-存储</td>
						<td class="text-left"><?php echo $cmr["CYCLE_STORAGE"]; ?></td>
						<td class="text-right">抄表周期-刷新</td>
						<td class="text-left"><?php echo $cmr["CYCLE_REF"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">板卡类型</td>
						<td class="text-left"><?php echo $cmr["BOARD_TYPE"]; ?></td>
						<td class="text-right">仪表数量</td>
						<td class="text-left"><?php echo $cmr["METER_NUM"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">签到周期</td>
						<td class="text-left"><?php echo $cmr["LOGIN_CYCLE"]; ?></td>
						<td class="text-right">心跳周期</td>
						<td class="text-left"><?php echo $cmr["HEARTBEAT_CYCLE"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">串口配置-通道1</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH1"]; ?></td>
						<td class="text-right">串口配置-通道2</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH2"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">串口配置-通道3</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH3"]; ?></td>
						<td class="text-right">串口配置-通道4</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH4"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">串口配置-通道5</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH5"]; ?></td>
						<td class="text-right">串口配置-通道6</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH6"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">串口配置-通道7</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH7"]; ?></td>
						<td class="text-right">串口配置-通道8</td>
						<td class="text-left"><?php echo $cmr["CONFIG_CH8"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">串口配置-485</td>
						<td class="text-left"><?php echo $cmr["CONFIG_RS485"]; ?></td>
					</tr>
					<tr>
						<td class="text-right">备注</td>
						<td class="text-left"><?php echo $cmr["NOTES"]; ?></td>
					</tr>
				</table>
			</div>
