  ...
  <div class="panel admin-panel">
    ...
    <div class="padding">
      ...
      <tr>
        ...
        <tr> 
         <td class="text-right">用户星级</td>
          <td class="text-left"colspan="3">
          <?php 
            $star = '';
            for ($i = 0; $i < $edit['user_star_rate']; $i = $i + 1) {
                $star = $star.'<i class="icon-star-o"></i>';      
            }
            echo $star;
            ?>
          </td>
        ...
        <tr> 
         <td class="text-right">用户评价</td>
          <td class="text-left"colspan="3"><?php echo $edit["user_service_rate"]; ?></td>
        </tr>
   </table>
   </div>
